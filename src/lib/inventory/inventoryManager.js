 ...
 * Inventory Manager
 * 
 * Handles all inventory operations: adding/removing items, transfers between ship and homebase,
 * capacity validation, slot validation for component installation.
 */
...
const itemDatabase = JSON.parse(
  readFileSync(join(__dirname, '../../data/items/itemDatabase.json'), 'utf-8')
);
 ...
 * {
 *   homebase: {
 *     items: { itemId: { ...itemData, quantity: number, instanceId: string } },
 *     capacity_m3: 1000,
 *     maxWeight_kg: 50000
 *   },
 *   ship: {
 ...
 *     maxWeight_kg: 10000,
 *     installedComponents: {
 *       weapon: [{ itemId, instanceId, slotIndex: 0 }],
 *       thruster: [{ itemId, instanceId, slotIndex: 0 }],
 *       sensor: [{ itemId, instanceId, slotIndex: 0 }],
 *       internal: [{ itemId, instanceId, slotIndex: 0 }],
 *       hull: [{ itemId, instanceId, slotIndex: 0 }],
 *       mainframe: [{ itemId, instanceId, slotIndex: 0 }]
 *     },
 *     slots: {
 *       weapon: 2,
 *       thruster: 1,
